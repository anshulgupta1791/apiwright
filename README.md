...
- **Per-endpoint and global case opt-outs** — Suppress any of the 19 skippable test-case kinds (18 §3 generators + the `assertion` sentinel) via `skip_cases` on the endpoint or `case_generation.skip_globally` in config. See [docs/skip-cases.md](./docs/skip-cases.md).
