...
| **[Skip cases](./skip-cases.md)** | Opting out of specific generated test-case kinds, per-endpoint or globally. Token grammar, the 18 skippable kinds, and the union rule. |
