 ...
 *   DD-7  `ALL_SKIPPABLE_KINDS` is a `ReadonlySet<SkippableKind>` with exactly 19 entries.
 ...
 * Exactly 18 §3 generated kinds plus the `"assertion"` sentinel = 19 total.
 */
...
/**
 * The complete set of skippable kinds — 18 §3 generated types plus the
 ...
 *
 * Invariant: `ALL_SKIPPABLE_KINDS.size === 19`.
 */
